...
def generate_launch_description():
    ...
    pkg_ardupilot_sitl_models = get_package_share_directory("ackermann_sitl_models")
    ...
    sdf_file = os.path.join(
        pkg_ardupilot_sitl_models, "models", "ackermann_model", "model.sdf"
    )
    with open(sdf_file, "r") as infp:
       ...
       #     "model://ackermann_model",
       #     "package://ackermann_sitl_models/models/ackermann_model")
        ...
        parameters=[
            {
                "config_file": os.path.join(
                    pkg_project_bringup, "config", "ackermann_bridge.yaml"
                ),
